...
public class Navidad {
			...
			case 1:
				...
				case 1:
					...
					for (int i = 0; i < 9; i++) {
						...
						comprobador(opcionRespuesta);
						verificador(opcionRespuesta, i, certeza);
						puntos (certeza, puntaje);
				...
				case 2:
					...
					for (int i = 0; i < 9; i++) {
						...
						opcionRespuesta1 = sc.nextInt();
						comprobador(opcionRespuesta1);
	...
	public static String[][] bloqueMates(int numPregunta, int numRespuesta) {
		...
		mates[2][1] = "1. Una antiderivación"; // TRue
		...
		mates[4][2] = "2. 7200";
		mates[4][3] = "3. 46200";
		mates[4][4] = "4. 86400"; // True
		mates[5][0] = "Dime cuánto vale π";
		mates[5][1] = "1. 3.14"; // True
		mates[5][2] = "2. 6";
		mates[5][3] = "3. 4.17";
		mates[5][4] = "4. 3.16";
	...
	public static String[][] bloqueBiologia(int numPregunta, int numRespuesta) {
		...
		biology[0][1] = "1. Realizar la fotosíntesis"; // True
		...
		biology[1][1] = "1. Un organismo procariota unicelular"; // True
		...
		biology[5][4] = "4. El tiburón boreal"; // True
		biology[6][0] = "Una vaca es...";
		biology[6][1] = "1. Un rumiante"; // TRue
	...
	public static int comprobador(int opcionRespuesta) {
		Scanner sc = new Scanner(System.in);
	...
	public static int comprobadorTusMuelasAlberto(int opcionRespuesta, int i) {
		Scanner sc = new Scanner(System.in);

		if ((i == 8)) {
			while (opcionRespuesta < 1 || opcionRespuesta > 2) {
				System.out.println("Error, vuelve a intentarlo.");
				opcionRespuesta = sc.nextInt();
			}
		} else {
	...
	public static boolean verificador(int opcionRespuesta, int i, boolean ola) {
		
		if (i == 0 & opcionRespuesta == 4) {
			ola = true;
		}
		else if (i == 1 & opcionRespuesta == 1) {
			ola = true;
		}
		else if (i == 2 & opcionRespuesta == 3) {
			ola = true;
		}
		else if (i == 3 & opcionRespuesta == 3) {
			ola = true;
		}
		else if (i == 4 & opcionRespuesta == 4) {
			ola = true;
		}
		else if (i == 5 & opcionRespuesta == 2) {
			ola = true;
		}
		else if (i == 6 & opcionRespuesta == 1) {
			ola = true;
		}
		else if (i == 7 & opcionRespuesta == 2) {
			ola = true;
		}
		else if (i == 8 & opcionRespuesta == 1) {
			ola = true;
		}
		return ola;
}
	public static int puntos (boolean ola, int puntaje) {
