...
public class Navidad {
					...
					switch (contadorCategoria) {
						case 1: 
							...
							for (int i = 0; i<9; i++) {
								...
								comprobadorTusMuelasAlberto (opcionRespuesta, i);
							}
							break;
						case 2:
							System.out.println("\nBALONCESTO\n");
	...
	public static void comprobador (int opcionRespuesta) {
		Scanner sc = new Scanner(System.in);
...
while (opcionRespuesta <1 || opcionRespuesta>4) {
	...
	public static void comprobadorTusMuelasAlberto (int opcionRespuesta, int i) {
		Scanner sc = new Scanner(System.in);
