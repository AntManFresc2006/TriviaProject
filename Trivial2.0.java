...
public class Trivial {
					...
					switch (dadoCategoria()) {
						case 1: 
							...
							for (int i = 0; i<9; i++) {
								...
								sc.nextLine();
								int correcta = respuestaFutbol (i);
								boolean comprobacion = respuestaComprobacion(correcta, opcionRespuesta);
								if (comprobacion==false) {
									i = 9;
									contadorBloques=4;
									System.out.println("\nOpción incorrecta. ¯|_(ツ)_/¯ \n Fin del juego. ");
								} else {
									System.out.println("\n(◠﹏◠)");
									System.out.println("\nOpción correcta.\n");
								}
						...
						case 2:
							...
							for (int i = 0; i<9; i++) {
								...
								opcionRespuesta = sc.nextInt();	
								sc.nextLine();
								int correcta = respuestaBaloncesto (i);
								boolean comprobacion = respuestaComprobacion(correcta, opcionRespuesta);
								if (comprobacion==false) {
									i = 9;
									contadorBloques=4;
						...
						case 3:
							...
							for (int i = 0; i<9; i++) {
								...
								opcionRespuesta = sc.nextInt();	
								sc.nextLine();
								int correcta = respuestaOlimpiadas (i);
								boolean comprobacion = respuestaComprobacion(correcta, opcionRespuesta);
								if (comprobacion==false) {
									i = 9;
									contadorBloques=4;
					...
					switch (dadoCategoria()) {
						case 1: 
							...
							for (int i = 0; i<9; i++) {
								...
								opcionRespuesta = sc.nextInt();
								sc.nextLine();
								int correcta = respuestaClasica (i);
								boolean comprobacion = respuestaComprobacion(correcta, opcionRespuesta);
								if (comprobacion==false) {
									i = 9;
									contadorBloques=4;
						...
						case 3:
							...
							for (int i = 0; i<9; i++) {
								for (int j = 0; j<5; j++) {
									String [][] matrixMedieval = bloqueMedieval(i,j);
									System.out.println(matrixMedieval[i][j]);
									
								}
								opcionRespuesta = sc.nextInt();
								sc.nextLine();
								int correcta = respuestaMedieval (i);
								boolean comprobacion = respuestaComprobacion(correcta, opcionRespuesta);
								if (comprobacion==false) {
									i = 9;
									contadorBloques=4;
					...
					switch (dadoCategoria()) {
						...
						case 2:
							...
							for (int i = 0; i<9; i++) {
								...
								opcionRespuesta = sc.nextInt();	
								sc.nextLine();
								int correcta = respuestaLiteratura (i);
								boolean comprobacion = respuestaComprobacion(correcta, opcionRespuesta);
								if (comprobacion==false) {
									i = 9;
									contadorBloques=4;
						...
						case 3:
							...
							for (int i = 0; i<9; i++) {
								...
								opcionRespuesta = sc.nextInt();	
								sc.nextLine();
								int correcta = respuestaGeneral (i);
								boolean comprobacion = respuestaComprobacion(correcta, opcionRespuesta);
								if (comprobacion==false) {
									i = 9;
									contadorBloques=4;
					...
					switch (dadoCategoria()) {
						...
						case 2:
							...
							for (int i = 0; i<9; i++) {
								...
								opcionRespuesta = sc.nextInt();	
								sc.nextLine();
								int correcta = respuestaBiologia (i);
								boolean comprobacion = respuestaComprobacion(correcta, opcionRespuesta);
								if (comprobacion==false) {
									i = 9;
									contadorBloques=4;
						...
						case 3:
							...
							for (int i = 0; i<9; i++) {
								...
								opcionRespuesta = sc.nextInt();	
								sc.nextLine();
								int correcta = respuestaFisica (i);
								boolean comprobacion = respuestaComprobacion(correcta, opcionRespuesta);
								if (comprobacion==false) {
									i = 9;
									contadorBloques=4;
	...
	public static String [][] bloqueOlimpiadas (int numPregunta, int numRespuesta) {
		...
		olimpiadas[5][1]="1. 2008";
		olimpiadas[5][2]="2. 2012";
		olimpiadas[5][3]="3. 2004";
		olimpiadas[5][4]="4. 2016";
	...
	public static String [][] bloqueClasico (int numPregunta, int numRespuesta) {
		...
		classicalEra[7][0] = "¿Cómo llamaron los romanos a la provincia que hoy en día corresponde al territorio andaluz?";
	...
	public static String [][]bloqueMedieval (int numPregunta, int numRespuesta) {
		...
		medieval[2][1] = "1. Se inició la decadencia de la era musulmana";
	...
	public static String[][] bloqueMates (int numPregunta, int numRespuesta) {
		...
		mates[5][3] = "3. 4.17";
		mates[5][4] = "4. 3.16";
		mates[6][0] = "Dime de los 4 siguientes numeros cuál no es primo: (4, 3, 11, 17)";
		mates[6][1] = "1. 3";
		mates[6][2] = "2. 11";
		mates[6][3] = "3. 4";
		mates[6][4] = "4. 17";
	...
	public static String [][] bloqueFisica (int numPregunta, int numRespuesta) {
		...
		physics[3][1] = "1. Cuando la trayectoria es recta";
		physics[3][2] = "2. Cuando la trayectoria es recta y la aceleración es constante";
		physics[3][3] = "3. Cuando la trayectoria es una línea recta y la velocidad es constante";
		physics[3][4] = "4. Ninguna es correcta";
	...
	public static boolean respuestaComprobacion(int opcion, int correcta) {
	...
	public static int respuestaFutbol(int posicion) {
		int [] futbol = new int [9];
		futbol [0] = 4;
		futbol [1] = 1;
		futbol [2] = 3;
		futbol [3] = 3;
		...
		futbol [7] = 2;
		futbol [8] = 1;
		int resultado = futbol[posicion];
		return resultado;
	}
	
	public static int respuestaBaloncesto(int posicion) {
		int [] baloncesto = new int [9];
		baloncesto [0] = 2;
		baloncesto [1] = 3;
		baloncesto [2] = 1;
		baloncesto [3] = 3;
		...
		baloncesto [7] = 3;
		baloncesto [8] = 2;
		int resultado = baloncesto[posicion];
		return resultado;
	}
	
	public static int respuestaOlimpiadas(int posicion) {
		int [] olimpiadas = new int [9];
		olimpiadas [0] = 4;
		olimpiadas [1] = 2;
		olimpiadas [2] = 3;
		olimpiadas [3] = 4;
		...
		olimpiadas [7] = 4;
		olimpiadas [8] = 2;
		int resultado = olimpiadas[posicion];
		return resultado;
	}
	
	public static int respuestaClasica(int posicion) {
		int [] clasica = new int [9];
		clasica [0] = 3;
		clasica [1] = 3;
		clasica [2] = 1;
		clasica [3] = 3;
		...
		clasica [7] = 4;
		clasica [8] = 4;
		int resultado = clasica[posicion];
		return resultado;
	}
	
	public static int respuestaXX(int posicion) {
		int [] xx = new int [9];
		xx [0] = 4;
		xx [1] = 4;
		xx [2] = 3;
		...
		xx [7] = 3;
		xx [8] = 1;
		int resultado = xx[posicion];
		return resultado;
	}
	
	public static int respuestaMedieval(int posicion) {
		int [] medieval = new int [9];
		medieval [0] = 2;
		medieval [1] = 1;
		medieval [2] = 1;
		medieval [3] = 3;
		...
		medieval [7] = 1;
		medieval [8] = 4;
		int resultado = medieval[posicion];
		return resultado;
	}
	
	public static int respuestaCine(int posicion) {
		int [] cine = new int [9];
		cine [0] = 3;
		cine [1] = 3;
		cine [2] = 2;
		...
		cine [7] = 3;
		cine [8] = 2;
		int resultado = cine[posicion];
		return resultado;
	}
	
	public static int respuestaLiteratura(int posicion) {
		int [] literatura = new int [9];
		literatura [0] = 2;
		literatura [1] = 1;
		literatura [2] = 3;
		literatura [3] = 2;
		...
		literatura [7] = 2;
		literatura [8] = 4;
		int resultado = literatura[posicion];
		return resultado;
	}
	
	public static int respuestaGeneral(int posicion) {
		int [] general = new int [9];
		general [0] = 3;
		general [1] = 2;
		general [2] = 3;
		general [3] = 1;
		...
		general [7] = 4;
		general [8] = 2;
		int resultado = general[posicion];
		return resultado;
	}
	
	public static int respuestaMates(int posicion) {
		int [] mates = new int [9];
		mates [0] = 4;
		mates [1] = 1;
		mates [2] = 1;
		...
		mates [7] = 4;
		mates [8] = 2;
		int resultado = mates[posicion];
		return resultado;
	}
	
	public static int respuestaBiologia(int posicion) {
		int [] biologia = new int [9];
		biologia [0] = 1;
		biologia [1] = 1;
		biologia [2] = 2;
		biologia [3] = 3;
		...
		biologia [7] = 4;
		biologia [8] = 2;
		int resultado = biologia[posicion];
		return resultado;
	}
	
	public static int respuestaFisica(int posicion) {
		int [] fisica = new int [9];
		fisica [0] = 3;
		fisica [1] = 1;
		fisica [2] = 1;
		fisica [3] = 2;
